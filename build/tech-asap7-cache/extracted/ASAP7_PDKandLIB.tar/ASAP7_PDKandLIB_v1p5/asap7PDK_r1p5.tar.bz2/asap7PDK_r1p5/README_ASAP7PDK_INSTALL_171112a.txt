...
▾ cdslib/						: Directory containing the ASAP7 technology file and technology
  ...
  ▸ asap7_TechLib_08/					: ASAP7 technology library.
...
1. Untar the PDK archive 'asap7PDK_r1p5.tar.bz2' (where 1p5 is the PDK
   version number) by using the following command:

   tar -xvjf asap7PDK_r1p5.tar.bz2 

2. Copy the untarred PDK 'asap7PDK_r1p5' to an install area.
