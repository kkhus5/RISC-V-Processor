...
+epsrsub = 11.9            easub   = 4.05            ni0sub  = 1.1e+016        bg0sub  = 1.17          
+nc0sub  = 2.86e+025       nsd     = 2e+026          ngate   = 0               nseg    = 5             
+l       = 2.1e-008        xl      = -5e-010         lint    = -3e-009         dlc     = 0             
+dlbin   = 0               hfin    = 3.4e-008        deltaw  = 0               deltawcv= 0             
+sdterm  = 0               epsrsp  = 3.9           
+toxg    = 1.80e-009
************************************************************
...
+qmtcencv= 0               etaqm   = 0.54            qm0     = 2.183e-012      pqm     = 0.66          
+u0      = 0.0237          etamob  = 4               up      = 0               ua      = 1.133         
+eu      = 0.05            ud      = 0.0105          ucs     = 0.2672          rdswmin = 0             
+rdsw    = 190             wr      = 1               rswmin  = 0               rdwmin  = 0             
+rshs    = 0               rshd    = 0               vsat    = 60000           deltavsat= 0.2           
+ksativ  = 1.592           mexp    = 2.491           ptwg    = 25              pclm    = 0.01          
+pclmg   = 1               pdibl1  = 800             pdibl2  = 0.005704        drout   = 4.97          
+pvag    = 200             fpitch  = 2.7e-008        rth0    = 0.15            cth0    = 1.243e-006    
+wth0    = 2.6e-007      
...
+epsrsub = 11.9            easub   = 4.05            ni0sub  = 1.1e+016        bg0sub  = 1.17          
+nc0sub  = 2.86e+025       nsd     = 2e+026          ngate   = 0               nseg    = 5             
+l       = 2.1e-008        xl      = -5e-010         lint    = -4.5e-009       dlc     = 0             
+dlbin   = 0               hfin    = 3.4e-008        deltaw  = 0               deltawcv= 0             
+sdterm  = 0               epsrsp  = 3.9           
+toxg    = 1.95e-009
************************************************************
