...
create_constraint_mode -name my_constraint_mode\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/clock_constraints_fragment.sdc\
     ${::IMEX::libVar}/mmmc/pin_constraints_fragment.sdc\
     ${::IMEX::libVar}/mmmc/riscv_top.mapped.sdc]
create_analysis_view -name PVT_0P63V_100C.setup_view -constraint_mode my_constraint_mode -delay_corner PVT_0P63V_100C.setup_delay
create_analysis_view -name PVT_0P77V_0C.hold_view -constraint_mode my_constraint_mode -delay_corner PVT_0P77V_0C.hold_delay
